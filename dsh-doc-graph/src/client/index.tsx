 ...
 * sidebar "文档图谱" entrance (next to data-agent's "数据"), and the graph
 * drawer overlay. The sidebar button is the only navigation entrance.
 */
...
function mountSidebarEntry(ctx: ClientContext): () => void {
  ...
  button.setAttribute('title', '打开文档图谱面板')
  ...
  const rootObserver = new MutationObserver(() => {
    if (root === null || !root.isConnected || !document.body.contains(button)) {
      placed = false
      tryPlace()
    }
  })
